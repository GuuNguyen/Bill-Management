...
namespace Bill_Management
{
    public class Service
    {
        ...
        private List<VNCustomer> vnc = new List<VNCustomer>();
        ...
        public void CreateVNCustomer()
        {
            ...
            vnc.Add(new VNCustomer(customerID, name, address, quantity, unitPrice, moneyPay, kindOfCustomer, norm));
        }
